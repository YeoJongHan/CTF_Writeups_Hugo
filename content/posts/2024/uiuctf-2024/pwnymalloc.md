...
[Download alloc.c](/gitbook/assets/alloc.c)

[Download alloc.h](/gitbook/assets/alloc.h)

[Download chal](/gitbook/assets/chal)

[Download main.c](/gitbook/assets/main.c)

[Download Makefile](/gitbook/assets/Makefile)
...
{{< tab label="handle_refund_request" >}}
```c
void handle_refund_request() {
    int request_id = -1;
    for (int i = 0; i < 10; i++) {
...
{{< tab label="handle_refund_status" >}}
```c
void handle_refund_status() {
    puts("Please enter your request ID:");
    char id_str[0x10];
